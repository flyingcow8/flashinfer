...
from .fused_moe import gen_fused_moe_sm80_module, gen_fused_moe_sm100_module
...
def gen_all_modules(
    ...
    # SM80+ fused MoE (simplified implementation)
    jit_specs.append(gen_fused_moe_sm80_module())
    if has_sm90:
